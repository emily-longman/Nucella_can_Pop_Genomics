...
else echo "Working scaffolds folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/genome_assembly/pilon/polished_genome_round_2/scaffolds; date
fi

#--------------------------------------------------------------------------------

## Import master partition file 
guide_file=$WORKING_FOLDER/data/processed/genome_assembly/pilon/guide_file_array_2.txt
...
--outdir $WORKING_FOLDER/data/processed/genome_assembly/pilon/polished_genome_round_2
...
$seqtk seq ${scaffold}.polished.fasta > $WORKING_FOLDER/data/processed/genome_assembly/pilon/polished_genome_round_2/scaffolds/${scaffold}.polished.fasta
