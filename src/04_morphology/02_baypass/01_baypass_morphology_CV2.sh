...
else echo "Working CV_2 folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/morphometrics/baypass/CV_2; date
fi

#--------------------------------------------------------------------------------

# Change directory 
cd $WORKING_FOLDER/data/processed/morphometrics/baypass/CV_2
