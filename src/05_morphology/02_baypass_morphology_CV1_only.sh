...
else echo "Working CV_1 folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/morphometrics/baypass/CV_1; date
fi

#--------------------------------------------------------------------------------

# Change directory 
cd $WORKING_FOLDER/morphometrics/baypass/CV_1
...
-efile $WORKING_FOLDER/morphometrics/guide_files/Baypass_morphology_CV_1.txt \
-d0yij 4 \
