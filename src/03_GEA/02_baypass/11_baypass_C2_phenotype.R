...
NC.Pheno.contrast.C2 <- read.table("data/processed/GEA/baypass/C2_Pheno/NC_baypass_C2_Pheno_summary_contrast.out", header=T)
...
pdf("output/figures/GEA/Baypass_Pheno_C2_hist.pdf", width = 5, height = 5)
hist(10**(-1*NC.Pheno.contrast.C2$log10.1.pval.),freq=F,breaks=50)
abline(h=1, col="red")
dev.off()

pdf("output/figures/GEA/Baypass_Pheno_C2_outliers.pdf", width = 5, height = 5)
