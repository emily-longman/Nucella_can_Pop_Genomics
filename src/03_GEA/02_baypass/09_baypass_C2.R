...
NC.S.vs.N.contrast.C2 <- read.table("data/processed/GEA/baypass/C2/NC_baypass_C2_summary_contrast.out", header=T)

NC.S.vs.N.contrast.C2.no_PGP <- read.table("data/processed/GEA/baypass/C2/NC_baypass_C2_no_PGP_summary_contrast.out", header=T)
...
pdf("output/figures/GEA/Baypass_C2_hist.pdf", width = 5, height = 5)
hist(10**(-1*NC.S.vs.N.contrast.C2$log10.1.pval.),freq=F,breaks=50)
abline(h=1, col="red")
dev.off()

pdf("output/figures/GEA/Baypass_C2_outliers.pdf", width = 5, height = 5)
...
# Check the behavior of the p-values associated to the C2
pdf("output/figures/GEA/Baypass_C2_hist_no_PGP.pdf", width = 5, height = 5)
hist(10**(-1*NC.S.vs.N.contrast.C2.no_PGP$log10.1.pval.),freq=F,breaks=50)
abline(h=1, col="red")
dev.off()

pdf("output/figures/GEA/Baypass_C2_outliers_no_PGP.pdf", width = 5, height = 5)
