...
else echo "Working RGSM_final_bams folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/fastq_to_vcf/RGSM_final_bams; date
fi
...
I=$WORKING_FOLDER/data/processed/fastq_to_vcf/bams_merged/${i}.lanes_merged.bam \
O=$WORKING_FOLDER/data/processed/fastq_to_vcf/RGSM_final_bams/${i}.bam \
...
samtools index $WORKING_FOLDER/data/processed/fastq_to_vcf/RGSM_final_bams/${i}.bam
