...
bcftools query -l $WORKING_FOLDER/data/processed/fastq_to_vcf/vcf_freebayes_relaxed_filt/N.canaliculata_pops.vcf.gz > $WORKING_FOLDER/guide_files/N.canaliculata_relaxed_filt_pops.vcf_pop_names.txt
