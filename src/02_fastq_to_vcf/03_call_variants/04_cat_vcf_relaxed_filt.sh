...
bcftools concat \
$WORKING_FOLDER/data/processed/fastq_to_vcf/vcf_freebayes_relaxed_filt/partitions/genome.scaffold.names.*.vcf.gz \
-Oz -o $WORKING_FOLDER/data/processed/fastq_to_vcf/vcf_freebayes_relaxed_filt/N.canaliculata_pops.vcf.gz