...
# This script will trim the reads with fastp.
...
else echo "Working logs folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/fastq_to_vcf/logs; date
fi
...
else echo "Working trimmed_reads folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/fastq_to_vcf/trimmed_reads; date
fi

if [ -d "trimmed_reads_reports" ]
then echo "Working trimmed_reads_reports folder exist"; echo "Let's move on."; date
else echo "Working trimmed_reads_reports folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/fastq_to_vcf/trimmed_reads_reports; date
fi
...
-i $RAW_READS/${read1} \
-I $RAW_READS/${read2} \
-o $WORKING_FOLDER/data/processed/fastq_to_vcf/trimmed_reads/${i}_R1_clean.fq.gz \
-O $WORKING_FOLDER/data/processed/fastq_to_vcf/trimmed_reads/${i}_R2_clean.fq.gz \
...
--html $WORKING_FOLDER/data/processed/fastq_to_vcf/trimmed_reads_reports/${i}_clean.html \
--json $WORKING_FOLDER/data/processed/fastq_to_vcf/trimmed_reads_reports/${i}_clean.json
