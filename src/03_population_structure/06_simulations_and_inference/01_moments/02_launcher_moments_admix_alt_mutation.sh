...
# Name this job
#SBATCH --job-name=moments_admix_alt_mutation
...
if [ -d "admix_alt_mutation" ]
then echo "Working admix_alt_mutation folder exist"; echo "Let's move on."; date
else echo "Working admix_alt_mutation folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/data/processed/pop_structure/admix_alt_mutation; date
fi
...
moment_script="$WORKING_FOLDER/src/03_population_structure/06_simulations_and_inference/01_moments/02_nucella.run_moments_admix_alt_mutation.py"
