...
#constants
mu = 8.6e-9 #Haliotis sorenseni (Wooldridge et al. 2025)
...
PMmod=open('o3step_alt_mutation/%s_output.3step.txt' % Pair_name,'w')
PMmod.write(
...
#This number is 5. i.e., count parameters. 
	...
	PMmod=open('o3step_alt_mutation/%s_output.3step.txt' % Pair_name,'a')
