...
--minQ 60 --maf 0.01 --max-missing 0.95 --remove-indels --recode --recode-INFO-all \
--out $WORKING_FOLDER/fastq_to_vcf/vcf_clean/N.canaliculata_pops_filter_minQ60_maxmissing0.95
...
vcftools --vcf $WORKING_FOLDER/fastq_to_vcf/vcf_clean/N.canaliculata_pops_filter_minQ60_maxmissing0.95.recode.vcf \
--FILTER-summary --out $WORKING_FOLDER/fastq_to_vcf/vcf_clean/N.canaliculata_pops_filter_minQ60_maxmissing0.95.recode.vcf
# Generate a file containing the depth per site summed across all individuals
vcftools --vcf $WORKING_FOLDER/fastq_to_vcf/vcf_clean/N.canaliculata_pops_filter_minQ60_maxmissing0.95.recode.vcf \
--depth --out $WORKING_FOLDER/fastq_to_vcf/vcf_clean/N.canaliculata_pops_filter_minQ60_maxmissing0.95.recode.vcf